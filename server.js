...
server.get('/', function(req, res) {
    const data = {
        ...
        description: 'Programador full-stack, focado em trazer o melhor ensino para iniciantes em programação. Colaborador <a href="https://rocketseat.com.br" target="_blank">Rocketseat</a>',
        links: [
